...
<template>
  <div class="grid gap-3 md:grid-cols-3" data-strategy-telemetry>
    ...
    <AppCard class="p-4 min-w-0">
      <div class="flex items-center justify-between gap-3 mb-3"><div><p class="text-xs uppercase tracking-wider" style="color:var(--text-faint)">&#x7B56;&#x7565;&#x7EDF;&#x8BA1;</p><h3 class="font-semibold mt-1">&#x77ED;&#x7EBF; / &#x6CE2;&#x6BB5;</h3></div><AppBadge tone="neutral">&#x5B9E;&#x65F6;&#x66F4;&#x65B0;</AppBadge></div>
    ...
    <AppCard class="p-4 min-w-0">
      <div class="flex items-center justify-between gap-3 mb-3"><div><p class="text-xs uppercase tracking-wider" style="color:var(--text-faint)">&#x51B3;&#x7B56;&#x72B6;&#x6001;</p><h3 class="font-semibold mt-1">WAIT &#x662F;&#x5F53;&#x524D;&#x72B6;&#x6001;</h3></div><AppBadge :tone="waitState?.code === 'AI_UNAVAILABLE' || waitState?.code === 'DATA_UNAVAILABLE' ? 'warning' : 'neutral'">{{ statusLabel }}</AppBadge></div>
